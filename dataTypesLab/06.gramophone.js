...
let rotation = (albumName.length * bandName.length) * songName.length / 2;
let numRotations = Math.ceil(rotation/2.5);
console.log(`The plate was rotated ${numRotations} times.`);
}
