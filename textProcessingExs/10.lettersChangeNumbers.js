...
// it a bit by doing the same but with multiple strings keeping track of only
// the total sum of all results. Once he started to solve this with more strings
//  and bigger numbers it became quite hard to do it only in his mind.
//  So he kindly asks you to write a program that calculates the
...
//   So we add 2 to the resulting number (12+2=14). Similarly for the second string s is lowercase
//    and its position is 19 so we multiply it with the number (17*19 = 323).
...
// Output
// Print on the console a single number: the total sum of all
