...
//  crystal and recommends the next procedure that will bring it closer to the desired frequency.
//   To reduce waste and the time it takes to make each crystal your program needs to
//    complete the process with the least number of operations. 
//    Each operation takes the same amount of time, but since they are done at different 
//    parts of the factory, the crystals have to be transported and thoroughly 
//    washed every time an operation different from the previous must be performed, 
...
// representing the desired final thickness and a series of numbers, 
// representing the thickness of crystal ore in microns. 
// Process each chunk and print to the console the order of
//  operations and the number of times they need to be repeated to bring them to the desired thickness.
// The input comes as a numeric array with a variable number of elements.
//  The first number is the target thickness and all following numbers
//   are the thickness of different chunks of quartz ore.
