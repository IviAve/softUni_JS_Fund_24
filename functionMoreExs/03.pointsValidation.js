...
//  and checks if the distances between each point (x, y) and the start of the 
//  Cartesian coordinate system (0, 0) and between the points themselves is valid. 
...
// The order of comparisons should always be first {x1, y1} to {0, 0}, then {x2, y2} 
// to {0, 0} and finally {x1, y1} to {x2, y2}. 
